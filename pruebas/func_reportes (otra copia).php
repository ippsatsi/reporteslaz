...
?>
          ...
          <div id="row_form">
            <div class="field_row_form">
              ...
              <div class="input_fecha">
                <input type="text" id="datepicker_desde" name="fecha_desde" value="<?php echo date('d/m/Y');?>" readonly><i class="fa fa-calendar" aria-hidden="true"></i>
              </div>
            </div>
            <div class="field_row_form">
              <label for="datepicker_hasta">Hasta:</label>
              <div class="input_fecha">
                <input type="text" id="datepicker_hasta" name="fecha_hasta" value="<?php echo date('d/m/Y');?>" readonly><i class="fa fa-calendar" aria-hidden="true"></i>
              </div>
            </div>
          </div>
          <div id="row_form">
  ...
  ?></select>
          ...
          <div id="row_form">
            ...
            <div class="field_row_form" id="error">
            <?php if ( $error <> "" )
{
  echo $error;
}?>
