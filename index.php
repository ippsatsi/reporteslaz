  ...
  if (isset($_POST['username']) && isset($_POST['password'])) {
    ...
    try {
     ...
     // echo "rol=".$rol."</br>";
      ...
      //echo "No puede iniciar sesion_1";
...
<!--  <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,700" rel="stylesheet">-->
  ...
  <div class="grid">
  <h1 class="logo">UCATEL </br>REPORTES</h1>

    <form name="formu" action="index.php" method="POST" class="form login">
      ...
      <?php
        if (isset($_POST['username']))
        {
          echo "<p>$error_message</p>";
          				echo "<script> document.formu.username.value='".$_POST['username']."';";
				echo "document.formu.password.value='';" ;
				echo "document.formu.password.focus();" ;
				echo "</script>"; 
        }
      ?>
